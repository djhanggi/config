...
# Enable full keyboard access for all controls (e.g. enable Tab in modals)
...
sudo defaults write /Volumes/foo/.Spotlight-V100/VolumeConfiguration.plist Exclusions -array-add '/Volumes'
